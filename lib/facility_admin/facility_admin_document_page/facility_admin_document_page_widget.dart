                                                                                ...
                                                                                Column(
                                                                                  ...
                                                                                  children: [
                                                                                    ...
                                                                                    Expanded(
                                                                                      child: Text(
                                                                                        FFLocalizations.of(context).getText(
                                                                                          'xbk6cxoi' /* Click to upload files or drag ... */,
                                                                                        ),
                                                                                    ...
                                                                                    Expanded(
                                                                                      child: Text(
                                                                                        FFLocalizations.of(context).getText(
                                                                                          'mrzzvn5u' /* PDF, DOC, DOCX up to 10MB */,
                                                                                        ),
                                                                                        textAlign: TextAlign.center,
