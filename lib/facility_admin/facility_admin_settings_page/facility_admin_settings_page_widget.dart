...
import 'facility_admin_settings_page_model.dart';
export 'facility_admin_settings_page_model.dart';

class FacilityAdminSettingsPageWidget extends StatefulWidget {
  const FacilityAdminSettingsPageWidget({super.key});

  static String routeName = 'facilityAdminSettingsPage';
  static String routePath = 'patientsSettingsPageCopy';

  @override
  State<FacilityAdminSettingsPageWidget> createState() =>
      _FacilityAdminSettingsPageWidgetState();
}

class _FacilityAdminSettingsPageWidgetState
    extends State<FacilityAdminSettingsPageWidget> {
  late FacilityAdminSettingsPageModel _model;
                                                                ...
                                                                if (selectedMedia !=
                                                                    ...
                                                                    selectedMedia.every((m) =>
                                                                        validateFileFormat(
                                                                            ...
                                                                            context))) {
                                                                  safeSetState(() =>
                                                                      _model.isDataUploading_uploadDataJdd =
                                                                          true);
                                                                  ...
                                                                  if (selectedUploadedFiles
                                                                    ...
                                                                    safeSetState(
                                                                        () {
                                                                      _model.uploadedLocalFile_uploadDataJdd =
                                                                          selectedUploadedFiles
                                                                              .first;
                                                                      _model.uploadedFileUrl_uploadDataJdd =
                                                                          downloadUrls
                                                                              .first;
                                                                    });
                                                                  } else {
                                                    ...
                                                    Align(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          '1jvc73vp' /* Insurance Information */,
                                                        ),
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                          ...
                                                          Padding(
                                                            ...
                                                            child:
                                                              ...
                                                              onPressed:
                                                                ...
                                                                context
                                                                    .pushNamed(
                                                                  FacilityAdminProfilePageWidget
                                                                      .routeName,
                                                                  queryParameters:
                                                                      {
                                                                    'patientAuthUser':
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Text(
                                                                    FFLocalizations.of(
                                                                            context)
                                                                        .getText(
                                                                      'tq5vkemm' /* Automatically update data */,
                                                                    ),
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .bodySmall
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Text(
                                                                    FFLocalizations.of(
                                                                            context)
                                                                        .getText(
                                                                      'gkisikbp' /* Get notified about appointment... */,
                                                                    ),
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .bodySmall
                                                            ...
                                                            children: [
                                                              Text(
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                                  'abrfmx7p' /* Two-Factor Authentication */,
                                                                ),
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodyLarge
                                                              ...
                                                              Text(
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                                  'nbju8419' /* Add extra security to your acc... */,
                                                                ),
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodySmall
                                                            ...
                                                            children: [
                                                              ...
                                                              Text(
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                                  'm4ojlaev' /* Allow anonymous usage analytic... */,
                                                                ),
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodySmall
