...
class _PaymentHistoryWidgetState extends State<PaymentHistoryWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<PaymentsRow>>(
      future: PaymentsTable().queryRows(
        queryFn: (q) => q.or(
            "payer_id.eq.${FFAppState().AuthuserID}, recipient_id.eq.${FFAppState().AuthuserID}"),
      ),
      builder: (context, snapshot) {
        ...
        List<PaymentsRow> paymentHistoryPaymentsRowList = snapshot.data!;
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'sxd2pvlg' /* Below are a summary of your in... */,
                        ),
                        style:
                            ...
                            child: TabBarView(
                              ...
                              children: [
                                Builder(
                                  builder: (context) {
                                    final all =
                                        paymentHistoryPaymentsRowList.toList();
                                ...
                                Builder(
                                  builder: (context) {
                                    final paid = paymentHistoryPaymentsRowList
                                        .where((e) =>
                                            e.paymentStatus != 'completed')
                                        .toList()
                                        .sortedList(
                                            keyOf: (e) => e.initiatedAt!,
                                            desc: false)
                                        .toList();
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  Column(
                                                    ...
                                                    children: [
                                                      Text(
                                                        '${paidItem.netAmount.toString()}  xaf',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .bodyLarge
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  Column(
                                                    ...
                                                    children: [
                                                      Text(
                                                        '${pendingItem.netAmount.toString()}  xaf',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .bodyLarge
