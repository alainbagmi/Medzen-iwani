...
import 'payment_status_page_model.dart';
export 'payment_status_page_model.dart';

class PaymentStatusPageWidget extends StatefulWidget {
  const PaymentStatusPageWidget({super.key});

  static String routeName = 'PaymentStatusPage';
  static String routePath = '/paymentStatusPage';
