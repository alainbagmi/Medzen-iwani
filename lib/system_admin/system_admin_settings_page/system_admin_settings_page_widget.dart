...
import 'system_admin_settings_page_model.dart';
export 'system_admin_settings_page_model.dart';

class SystemAdminSettingsPageWidget extends StatefulWidget {
  const SystemAdminSettingsPageWidget({super.key});

  static String routeName = 'systemAdmin_settings_Page';
  static String routePath = 'systemAdmin_settings_Page';

  @override
  State<SystemAdminSettingsPageWidget> createState() =>
      _SystemAdminSettingsPageWidgetState();
}

class _SystemAdminSettingsPageWidgetState
    extends State<SystemAdminSettingsPageWidget> {
  late SystemAdminSettingsPageModel _model;
                                                                ...
                                                                if (selectedMedia !=
                                                                    ...
                                                                    selectedMedia.every((m) =>
                                                                        validateFileFormat(
                                                                            ...
                                                                            context))) {
                                                                  safeSetState(() =>
                                                                      _model.isDataUploading_uploadDataL4r =
                                                                          true);
                                                                  ...
                                                                  if (selectedUploadedFiles
                                                                    ...
                                                                    safeSetState(
                                                                        () {
                                                                      _model.uploadedLocalFile_uploadDataL4r =
                                                                          selectedUploadedFiles
                                                                              .first;
                                                                      _model.uploadedFileUrl_uploadDataL4r =
                                                                          downloadUrls
                                                                              .first;
                                                                    });
                                                                  } else {
                                                    ...
                                                    Align(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'unmrsry3' /* Insurance Information */,
                                                        ),
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Text(
                                                                    FFLocalizations.of(
                                                                            context)
                                                                        .getText(
                                                                      'ryu4slxx' /* Automatically update data */,
                                                                    ),
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .bodySmall
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Text(
                                                                    FFLocalizations.of(
                                                                            context)
                                                                        .getText(
                                                                      'zgwi3bfl' /* Get notified about appointment... */,
                                                                    ),
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .bodySmall
                                                            ...
                                                            children: [
                                                              Text(
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                                  '5su6wa76' /* Two-Factor Authentication */,
                                                                ),
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodyLarge
                                                              ...
                                                              Text(
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                                  'ubzzju4n' /* Add extra security to your acc... */,
                                                                ),
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodySmall
                                                            ...
                                                            children: [
                                                              ...
                                                              Text(
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                                  'yczzblrl' /* Allow anonymous usage analytic... */,
                                                                ),
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodySmall
