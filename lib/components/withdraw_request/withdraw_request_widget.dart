              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      'Your current balance is  ${formatNumber(
                        widget!.balance,
                        formatType: FormatType.compact,
                        currency: 'XAF ',
                      )} And  Your withrawal request is : ${valueOrDefault<String>(
                        formatNumber(
                    ...
                    child: Column(
                      ...
                      children: [
                              ...
                              Expanded(
                                child: FlutterFlowDropDown<String>(
                                  ...
                                  hintText: FFLocalizations.of(context).getText(
                                    'o4fclupt' /* Select Withdrawal method... */,
                                  ),
                                  icon: Icon(
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'beearmmz' /* Requested amount must not be g... */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Align(
                                alignment: AlignmentDirectional(0.0, 0.05),
                                child: FFButtonWidget(
                                  onPressed: ((_model.paymentMethodValue ==
                                                  null ||
                                              _model.paymentMethodValue ==
                                                  '') ||
                                          (_model.textController.text == null ||
                                              _model.textController.text ==
                                                  '') ||
                                          (_model.userPhoneNumber == null ||
                                              _model.userPhoneNumber == '') ||
                                          ((int.parse(_model
                                                      .textController.text)
                                                  .toDouble()) >
                                              widget!.balance))
                                          ...
                                          if (widget!.providerid != null &&
                                            ...
                                            if ((int.parse(_model
                                              ...
                                              ScaffoldMessenger.of(context)
                                                ...
                                                SnackBar(
                                                  content: Text(
                                                    'Requested Amount must be less than or   equal  ${widget!.balance.toString()}',
                                                    style: TextStyle(
                                                      color:
                                                          FlutterFlowTheme.of(
                                                                  context)
