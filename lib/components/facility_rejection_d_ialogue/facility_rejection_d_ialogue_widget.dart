...
import 'facility_rejection_d_ialogue_model.dart';
export 'facility_rejection_d_ialogue_model.dart';
...
class FacilityRejectionDIalogueWidget extends StatefulWidget {
  ...
  State<FacilityRejectionDIalogueWidget> createState() =>
      _FacilityRejectionDIalogueWidgetState();
}

class _FacilityRejectionDIalogueWidgetState
    extends State<FacilityRejectionDIalogueWidget>
    with TickerProviderStateMixin {
  late FacilityRejectionDIalogueModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FacilityRejectionDIalogueModel());
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      FFLocalizations.of(context).getText(
                        '5rb6im9g' /* Please provide reason for reje... */,
                      ),
