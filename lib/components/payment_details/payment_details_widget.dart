...
class PaymentDetailsWidget extends StatefulWidget {
  ...
  final String? id;
  final List<PaymentsRow>? payments;
  final String? service;
  final List<WithdrawalsRow>? withdrawals;
                      ...
                      builder: (context) {
                        if (widget!.service == 'payments') {
                              ...
                              builder: (context) {
                                ...
                                return ListView.separated(
                                  ...
                                  separatorBuilder: (_, __) =>
                                      SizedBox(height: 7.0),
                                  itemBuilder: (context, userpaymentsIndex) {
                                    final userpaymentsItem =
                                        userpayments[userpaymentsIndex];
                                    return Material(
                                              ...
                                              Expanded(
                                                child: Padding(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      Text(
                                                        'Refe #:  ${userpaymentsItem.paymentReference}',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .bodyLarge
                          ...
                          return Padding(
                            ...
                            child: Builder(
                              builder: (context) {
                                final userwithdrawals = widget!.withdrawals
                                        ?.sortedList(
                                            keyOf: (e) => e.processedAt!,
                                            desc: true)
                                        ?.toList() ??
                                    [];
                                ...
                                return ListView.separated(
                                  ...
                                  separatorBuilder: (_, __) =>
                                      SizedBox(height: 7.0),
                                  itemBuilder: (context, userwithdrawalsIndex) {
                                    final userwithdrawalsItem =
                                        userwithdrawals[userwithdrawalsIndex];
                                    return Material(
                                      color: Colors.transparent,
                                      elevation: 50.0,
                                      shape: RoundedRectangleBorder(
                                              ...
                                              Expanded(
                                                child: Padding(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      Text(
                                                        'Refe #:  ${userwithdrawalsItem.refId}',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .bodyLarge
