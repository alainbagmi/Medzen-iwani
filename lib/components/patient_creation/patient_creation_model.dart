...
import 'patient_creation_widget.dart' show PatientCreationWidget;
...
class PatientCreationModel extends FlutterFlowModel<PatientCreationWidget> {
  ...
  String? _roleTextControllerValidator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'yudirfx4' /* First Name is required */,
      );
    }
  ...
  String? _lastNameTextControllerValidator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'ah02sqgt' /* Last Name is required */,
      );
    }
  ...
  String? _patientDateOfBirthTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '14jnbgb3' /* Date Of Birth is required */,
      );
    }
  ...
  String? _patientIDCARDNUmTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '9m8agvou' /* ID Card Number Is Required */,
      );
    }
  ...
  String? _patientIDCARDDATEOFISSUETextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'jm4ua8gv' /* ID CARD DATE OF ISSUE is requi... */,
      );
    }
  ...
  String? _patientIDCARDDATEOFEXPIRATIONTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '55pwda06' /* ID CARD DATE OF EXPIRATION is ... */,
      );
    }
  ...
  String? _selectGenderTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'o3lbxuy1' /* Select Gender is required */,
      );
    }
  ...
  String? _emergencyNamesTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'fc105bqi' /* Emergency Names is required */,
      );
    }
  ...
  String? _confirmPasswordTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '4i2h6qbw' /* Confirm Password is required */,
      );
    }
  ...
  bool? checkboxValue;
  // Stores action output result for [Backend Call - API (Firebase Create User)] action in Button widget.
  ...
  PatientProfilesRow? patientprofile;
  // Stores action output result for [Backend Call - Insert Row] action in Button widget.
  PatientFacilitiesRow? profile;
