                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context).getText(
                                'wrw707dk' /* Card Payments (Visa, Master) */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .titleMedium
                                  .override(
                                  ...
                                  children: [
                                    ...
                                    TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          't4gurw52' /* Enter cardholder name */,
                                        ),
