...
import 'medzen_footer_model.dart';
export 'medzen_footer_model.dart';

class MedzenFooterWidget extends StatefulWidget {
  const MedzenFooterWidget({super.key});

  @override
  State<MedzenFooterWidget> createState() => _MedzenFooterWidgetState();
}

class _MedzenFooterWidgetState extends State<MedzenFooterWidget>
    with TickerProviderStateMixin {
  late MedzenFooterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MedzenFooterModel());
                          ...
                          children: [
                            Expanded(
                              child: Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'edvxk2kz' /* Connect with  medical Provider... */,
                                  ),
                                  textAlign: TextAlign.center,
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                              ...
                              children: [
                                Expanded(
                                  child: Align(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        '06ehtd2r' /* Download Our Mobile App */,
                                      ),
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .bodySmall
                  ...
                  Wrap(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            '66n4tqsl' /* Mylestechsolutions© 2025. All ... */,
                          ),
                          textAlign: TextAlign.center,
                          style: FlutterFlowTheme.of(context)
                              .bodyMedium
