...
import 'summary_notes_model.dart';
export 'summary_notes_model.dart';

class SummaryNotesWidget extends StatefulWidget {
  const SummaryNotesWidget({
    ...
    this.practitioner,
    this.facilityid,
  })  : this.providerName = providerName ?? 'Name of doctor or facility',
  ...
  @override
  State<SummaryNotesWidget> createState() => _SummaryNotesWidgetState();
}

class _SummaryNotesWidgetState extends State<SummaryNotesWidget>
    with TickerProviderStateMixin {
  late SummaryNotesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SummaryNotesModel());

    _model.textController ??= TextEditingController(
        text: widget!.actionFor == 'notes' ? widget!.consultationNotes : '');
                              ...
                              builder: (context) => Container(
                                ...
                                child: TextFormField(
                                  ...
                                  readOnly: (valueOrDefault(
                                          ...
                                          'patient') &&
                                      (widget!.actionFor == 'notes'),
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    isDense: true,
                                    labelText: widget!.actionFor == 'notes'
                                        ? 'Consultation Notes'
                                        : 'Comment',
