...
import 'dart:ui';
import '/index.dart';
import 'a_i_chat_history_page_widget.dart' show AIChatHistoryPageWidget;
...
class AIChatHistoryPageModel extends FlutterFlowModel<AIChatHistoryPageWidget> {
  ...
  // Stores action output result for [Backend Call - Query Rows] action in AIChatHistoryPage widget.
  List<AiConversationsRow>? conversation;
