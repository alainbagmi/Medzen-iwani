...
import 'dart:ui';
import '/index.dart';
import 'care_center_status_page_widget.dart' show CareCenterStatusPageWidget;
import 'dart:async';
...
class CareCenterStatusPageModel
    extends FlutterFlowModel<CareCenterStatusPageWidget> {
  ...
  // Stores action output result for [Backend Call - API (Facilities)] action in CareCenterStatusPage widget.
  ...
  Completer<List<FacilitiesRow>>? requestCompleter;
