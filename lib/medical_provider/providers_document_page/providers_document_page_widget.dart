                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      '3esad3wl' /* Provider Content Management */,
                                    ),
                                              ...
                                              children: [
                                                ...
                                                FlutterFlowDropDown<String>(
                                                  ...
                                                  options: [
                                                    ...
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      '44eldcei' /*   PDF Document */,
                                                    ),
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'sawp9vd3' /*   External Link */,
                                                    ),
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'sdbjpiph' /*   Health Tips & Awareness Post... */,
                                                    ),
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      '386m6m8x' /*    Research Summary / Update */,
                                                    ),
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      '8bq10l5a' /*   Podcast / Audio Clip */,
                                                    ),
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      's5n7t9ag' /*   Patient Education Handout */,
                                                    ),
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'z90ir98q' /*   Newsletter / Announcement */,
                                                    )
                                                  ],
                                                  onChanged: (val) =>
                                                      safeSetState(() => _model
                                                  ...
                                                  decoration: InputDecoration(
                                                    ...
                                                    hintText:
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                      '9xokw1lv' /* Write your article content her... */,
                                                    ),
                                                    hintStyle: FlutterFlowTheme
                                                            .of(context)
                                                        .bodyMedium
                                                        ...
                                                        children: [
                                                          InkWell(
                                                            ...
                                                            onTap: () async {
                                                              ...
                                                              if (selectedFiles !=
                                                                  null) {
                                                                safeSetState(() =>
                                                                    _model.isDataUploading_uploadDataM85 =
                                                                        true);
                                                                ...
                                                                if (selectedUploadedFiles
                                                                  ...
                                                                  safeSetState(
                                                                      () {
                                                                    _model.uploadedLocalFiles_uploadDataM85 =
                                                                        selectedUploadedFiles;
                                                                    _model.uploadedFileUrls_uploadDataM85 =
                                                                        downloadUrls;
                                                                  });
                                                                  showUploadMessage(
                                                                    context,
                                                          ...
                                                          Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              'vo4j0ryu' /* Click to upload files or drag ... */,
                                                            ),
                                                            textAlign: TextAlign
                                                                .center,
                                                          ...
                                                          Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              '93y39a42' /* PDF, DOC, DOCX up to 10MB */,
                                                            ),
                                                            textAlign: TextAlign
                                                                .center,
                                                            style: FlutterFlowTheme
