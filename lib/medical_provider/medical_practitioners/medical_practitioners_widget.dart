...
class MedicalPractitionersWidget extends StatefulWidget {
  const MedicalPractitionersWidget({
    super.key,
    this.gender,
    this.specialty,
  });
...
class _MedicalPractitionersWidgetState extends State<MedicalPractitionersWidget>
  ...
  void initState() {
    ...
    _model.searchProvidersTextController ??= TextEditingController();
    _model.searchProvidersFocusNode ??= FocusNode();
                              ...
                              Expanded(
                                child: Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.searchProvidersTextController,
                                      focusNode:
                                          _model.searchProvidersFocusNode,
                                      onFieldSubmitted: (_) async {
                                        _model.searchProviders = _model
                                            .searchProvidersTextController.text;
                                        safeSetState(() {});
                                      },
                                      autofocus: false,
                                      obscureText: false,
                      ...
                      child: Padding(
                        ...
                        child: FutureBuilder<List<MedicalPractitionersViewRow>>(
                          future: MedicalPractitionersViewTable().queryRows(
                            queryFn: (q) => q.or(
                                "application_status.eq.\"approved\", name.eq.${_model.searchProviders}, gender.eq.${_model.filters}"),
                          ),
                          builder: (context, snapshot) {
                            ...
                            return ListView.builder(
                              ...
                              itemCount: listViewMedicalPractitionersViewRowList
                                  .length,
                                                                          ...
                                                                          Expanded(
                                                                            child:
                                                                              ...
                                                                              valueOrDefault<String>(
                                                                                listViewMedicalPractitionersViewRow.name,
                                                                                'null',
                                                                              ),
                                                                          ...
                                                                          children: [
                                                                            Expanded(
                                                                              child: Padding(
                                                                                ...
                                                                                child: Text(
                                                                                  valueOrDefault<String>(
                                                                                    listViewMedicalPractitionersViewRow.specialization,
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onPressed:
                                                                                () async {
                                                                              context.pushNamed(
                                                                                PractionerDetailWidget.routeName,
                                                                                queryParameters: {
                                                                                  ...
                                                                                  return Padding(
                                                                                    ...
                                                                                    child: BookingSummaryWidget(
                                                                                      ...
                                                                                      amount: valueOrDefault<double>(
                                                                                        listViewMedicalPractitionersViewRow.fees,
                                                                                        0.0,
                                                                                      ),
                                                                                      providerid: listViewMedicalPractitionersViewRow.providerid,
                                                                                      imageurl: valueOrDefault<String>(
                                                                                        listViewMedicalPractitionersViewRow.picture,
                                                                                        'https://noaeltglphdlkbflipit.supabase.co/storage/v1/object/public/Default_patient_pic/default_profile.png',
                                                                                      ),
                                                                                    ),
                                                                                  );
