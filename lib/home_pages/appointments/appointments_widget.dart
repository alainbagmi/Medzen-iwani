  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (FFAppState().UserRole == 'patient') {
        _model.patientappointments =
            await SupaBaseRestGroup.patientAppointmentsCall.call(
          patientId: 'eq.${FFAppState().AuthuserID}',
        );

        if ((_model.patientappointments?.succeeded ?? true)) {
          _model.appointments = (_model.patientappointments?.jsonBody ?? '')
              .toList()
              .cast<dynamic>();
          safeSetState(() {});
        } else {
      ...
      } else if (FFAppState().UserRole == 'medical_provider') {
        _model.providerappointments =
            await SupaBaseRestGroup.medicalProviderAppointmentsCall.call(
          providerId: 'eq.${FFAppState().AuthuserID}',
        );

        if ((_model.providerappointments?.succeeded ?? true)) {
          _model.appointments = (_model.providerappointments?.jsonBody ?? '')
              .toList()
              .cast<dynamic>();
          safeSetState(() {});
        } else {
        ...
        _model.facilityAppointments =
            await SupaBaseRestGroup.facilityAppointmentsCall.call(
          facilityId: 'eq.${FFAppState().AuthuserID}',
        );

        if ((_model.facilityAppointments?.succeeded ?? true)) {
          _model.appointments = (_model.facilityAppointments?.jsonBody ?? '')
              .toList()
              .cast<dynamic>();
          safeSetState(() {});
        } else {
                    ...
                    children: [
                      Container(
                        ...
                        child: ClipRRect(
                          ...
                          child: Image.asset(
                            'assets/images/Screenshot_2025-07-08_at_6.58.46_PM.png',
                            width: 100.0,
                            fit: BoxFit.fitWidth,
                          ),
                        ),
                      ...
                      Expanded(
                        child: TabBarView(
                          ...
                          children: [
                                                            ...
                                                            children: [
                                                              ...
                                                              Column(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Text(
                                                                    'Date :  ${upcomingappointmentsItem.appointmentStartDate}',
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .bodyMedium
                                                                        .override(
                                                                  ...
                                                                  Text(
                                                                    'Time : ${upcomingappointmentsItem.appointmentStartTime}',
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .bodyMedium
                                                                        .override(
                            ...
                            Builder(
                              builder: (context) {
                                final pendingAppointments = _model.appointments
                                    .where((e) =>
                                        AppointmentsStruct.maybeFromMap(e)
                                            ?.appointmentStatus ==
                                        'pending')
                                    .toList();
                                ...
                                return ListView.separated(
                                  ...
                                  separatorBuilder: (_, __) =>
                                      SizedBox(height: 10.0),
                                  itemBuilder:
                                      (context, pendingAppointmentsIndex) {
                            ...
                            Builder(
                              builder: (context) {
                                final pastAppointments = _model.appointments
                                    .where((e) =>
                                        AppointmentsStruct.maybeFromMap(e)
                                            ?.appointmentStatus ==
                                        'completed')
                                ...
                                return ListView.separated(
                                  ...
                                  itemBuilder:
                                    ...
                                    final pastAppointmentsItem =
                                        pastAppointments[pastAppointmentsIndex];
                                    return Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          10.0, 0.0, 10.0, 0.0),
                                      child: Container(
