...
class RolePageWidget extends StatefulWidget {
  ...
  static String routeName = 'Role_page';
                                        ...
                                        children: [
                                          ...
                                          TextSpan(
                                            ...
                                            recognizer: TapGestureRecognizer()
                                              ..onTap = () async {
                                                context.pushNamed(
                                                    SystemAdminAccountCreationWidget
                                                        .routeName);
                                              },
                                          )
                                        ],
                                        ...
                                        child: Align(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'nhoe94i3' /* Welcome to MedZen Health */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .titleMedium
                                                .override(
                                    ...
                                    children: [
                                      Expanded(
                                        child: Align(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'y18qorra' /* Let's set up your profile to g... */,
                                            ),
                                            textAlign: TextAlign.center,
                                            style: FlutterFlowTheme.of(context)
                                                .titleSmall
                                          ...
                                          child: Align(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'h0cnz8yc' /* Please Select Your Role */,
                                              ),
                                              textAlign: TextAlign.center,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'skza7ixp' /* I need medical consultation */,
                                                        ),
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'la19gz1c' /* I provide medical services */,
                                                        ),
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'zncshnt2' /* Manage users and system settin... */,
                                                        ),
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                    ...
                                                    children: [
                                                      Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'kh5baj20' /* Facility Administrator */,
                                                        ),
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                      ...
                                                      Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'sk4b81vf' /* Manage Facility and Users */,
                                                        ),
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
